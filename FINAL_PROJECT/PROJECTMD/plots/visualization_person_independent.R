...
for(c in 1:length(result)){
  temporary_acc[[c]]<-apply(pi_result[[c]]$v1,2,mean)
  temporary_time[[c]]<-apply(pi_result[[c]]$v2,2,mean)
}
...
jpeg(file="/Users/elisabetta/Desktop/ML/Machine_Learning/FINAL_PROJECT/PROJECTMD/plots/cluster_pi.png",width = 700,height=500)
...
pd_cluster<-pd_cluster+labs(title="Clustering Data (person independent learning problem)", x="Increasing number of clusters", y = "Accuracy in percentage")+
  theme_classic() 
...
t_pd_cluster<-t_pd_cluster+labs(title="Time in seconds for every cluster (person independent learning problem)", x="Increasing number of clusters", y = "Accuracy in percentage")+
  theme_classic() 
...
jpeg(file="/Users/elisabetta/Desktop/ML/Machine_Learning/FINAL_PROJECT/PROJECTMD/plots/knn_pi.png",width = 700,height=500)
...
dp_k<-dp_k+labs(title="Accuracy for best cluster using multiple k values (person independent learning problem)", x="Increasing number of k", y = "Accuracy in percentage")+
  theme_classic() 
...
t_dp_k<-t_dp_k+labs(title="Time for best cluster using multiple k values (person independent learning problem)", x="Increasing number of k", y = "Time in seconds")+
  theme_classic() 
